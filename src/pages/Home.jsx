        ...
        <div>
            <header>
                ...
                <div className="p-8 md:pb-64 md:pt-64
                    ...
                    {/* Slogan */}
                    <div className="pb-8">
                        <h1>Let your community grow, the <span className="text-yellow bg-blue dark:bg-pink">b</span>right way</h1>
                    </div>
                ...
                {/* TEMPORARY (hardcoded) */}
                {/* Features */}
                <div id="features" className="p-8 md:pb-32 md:pt-32
                                flex flex-row justify-center gap-16 items-center
                                md:text-center
                                bg-gray-100 dark:bg-gray-900">

                    <div className="flex flex-col 
                                    text-left w-72">
                        <h1>Create and manage community objectives</h1>
                        <p>Flora provides pre-defined objectives but also gives you the ability to create custom ones, keeping your community busy with whatever fits best!</p>
                    </div>
                ...
                <div className="p-8 md:pb-32 md:pt-32
                                flex flex-row-reverse justify-center gap-16 items-center
                                md:text-center
                                dark:bg-gray-800">

                    <div className="flex flex-col 
                                    text-right w-72">
                        <h1>Show off your reputation</h1>
                        <p>Having Flora on your guild for a while also ensures to new users you’re the real deal! The more time passes, the more public reputation you gain.  </p>
                    </div>
                ...
                <div className="p-8 md:pb-32 md:pt-32
                    ...
                    <div className="flex flex-col 
                                    text-left w-72">
                        <h1>Make the leaderboards count</h1>
                        <p>Use all the tools Flora provides to the extreme! Give out prizes to top users or even organize events at the end of an objective. </p>
                    </div>
...
const Feature = ({image, title, description, side}) => {

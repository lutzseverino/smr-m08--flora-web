...
const NavBar = () => {
    return (
        <nav className="w-screen pt-4 pb-4 pl-9 pr-9
                        flex flex-row justify-between items-center
                        dark:bg-gray-900 dark:text-white">

            {/* Logo */}
            <div>
                <a href="index.html"><svg className="fill-blue dark:fill-green" height="48" width="48" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
...
const MobileNavBar = () => (
    <div className="flex flex-col gap-8 fixed top-0 right-0 backdrop-contrast-50
        ...
        <div className="flex flex-row justify-between">
            <a href="index.html"><h1>Flora</h1></a>
